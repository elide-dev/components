...
const STATUS_META: Record<SupportStatus, { label: string; icon: LucideIcon; color: string }> = {
  yes: { label: "Supported", icon: Check, color: "var(--eld-success-strong)" },
  no: { label: "Not supported", icon: X, color: "var(--subtle-foreground)" },
  partial: { label: "Partial", icon: CircleDot, color: "var(--eld-warning-strong)" },
};
